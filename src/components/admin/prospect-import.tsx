    ...
    <Card>
      <CardHeader className="pb-2">
        <div className="flex items-start gap-2">
          ...
          <div>
            <CardTitle className="leading-[24px]">Import prospects</CardTitle>
      ...
      <CardContent>
        ...
        <p className="mt-3 text-xs text-slate-500">{message || "Columns: name, email, company, city, phone, status, lead_score, notes."}</p>
      </CardContent>
    </Card>
  );
}
